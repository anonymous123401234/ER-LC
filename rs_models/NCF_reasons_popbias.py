...
class NeuMFReasonsPop(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        if "amazoncd" in dataset_name:
            tmp_file_path = "/rs_models/popularity/cluster_results_MiniLM_UMAP20_openai-amazoncd_logfrequency.pkl"
        else:
            tmp_file_path = "/rs_models/popularity/cluster_results_MiniLM_UMAP20_openai-movielens_logfrequency.pkl"
